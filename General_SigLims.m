...
output_path = '/Users/claudiagoh/Desktop/MATLAB/LAVI-main'; % output folder
output_file = 'SIGLIM2'; % output file name. The original file is called SIGLIM

FS = 1000; % use 1000
DUR = 120*[2,3,5,10]; % testing with a shorter duration first in sec
B = [-1.2:0.4:0];%[-4:0.2:-1.8, -1.7:0.1:0];
a = 1;
reps = 20;

f = 10.^(log10(0.5):0.025:log10(120)); % using a wider range of frequencies
width = 5;
lag = 1.5;
